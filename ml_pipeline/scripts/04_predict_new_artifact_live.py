"""
Unified live prediction entry point for new or free-text artifacts.

This script uses the same shared reasoning and output path as the existing-artifact
prediction entry point so the demo stays consistent and explainable.
"""
...
def main():
    """Run the unified live prediction workflow for any free-text artifact input."""
